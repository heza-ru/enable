  ...
  return (
    ...
    >
      <div className="flex w-full items-center justify-end p-4">
        <div className="absolute top-[13px] right-[9px] p-2 hover:bg-zinc-100 dark:hover:bg-zinc-700">
          <FullscreenIcon />
        </div>
      </div>
    </div>
...
const PureDocumentHeader = ({
  ...
  <div className="flex flex-row items-start justify-between gap-2 p-4 sm:items-center dark:bg-muted">
...
const DocumentContent = ({ document }: { document: Document }) => {
  ...
  const containerClassName = cn(
    "h-[257px] overflow-y-scroll dark:bg-muted",
    {
